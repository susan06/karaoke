...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-xs-12">
            <h3 class="page-header"><i class="fa fa-user"></i> @lang('app.activity_log_by') {{ $user->present()->nameOrEmail }}</h3>
        </div>
    </div>
                                ...
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-primary"><span class="fa fa-search"></span></button>
                                     @if (Input::has('search') && Input::get('search') != '')
                                      <a href="{{ route('activity.user.client', $user->id ) }}" class="btn btn-danger">
