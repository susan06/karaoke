...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-play-circle"></i> @lang('app.most_requested')</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="{{route('dashboard')}}"> Home</a></li>
                <li><i class="fa fa-play-circle"></i><a href="{{route('song.search')}}"> Canciones</a></li>
                <li><i class="fa fa-bars"></i> @lang('app.most_requested')</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                  Top de canciones mas solicitadas
                </header>
